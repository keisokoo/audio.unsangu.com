        ...
        <div className="inner-container">
          <div className="flex flex-col items-center justify-center min-h-screen">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4">
                <div className="min-h-[150px] flex flex-col gap-4 bg-slate-700 p-4 rounded-md">
                  <input
                    ref={inputRef}
                    type="file"
                    className="hidden"
                  ...
                  <button
                    onClick={() =>
                      updateAudioSettings({ loop: !audioSettings.loop })
                    }
                  >
                ...
                <div className="flex flex-col gap-4 overflow-y-auto h-[400px] bg-slate-700 p-4 rounded-md">
          ...
          <div className="fixed-dummy"></div>
        </div>
        <div className={"fixed-footer"}>hi</div>
      </div>
    </>
  );
}
